...
GAME_VERSION = MODLIST["minecraft_version"] if "minecraft_version" in MODLIST else CONFIG["minecraft_version"]
LOADER = MODLIST["mod_loader"] if "mod_loader" in MODLIST else CONFIG["mod_loader"]
